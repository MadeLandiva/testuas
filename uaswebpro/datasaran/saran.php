    ...
    <div id="app">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item active ">
                            <a href="saran.php" class='sidebar-link'>
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h3>Data Kritik dan Saran Mahasiswa Instiki</h3>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                <?php
                                    $query = "SELECT * FROM tb_saran INNER JOIN tb_mahasiswa ON tb_saran.id_mahasiswa=tb_mahasiswa.id_mahasiswa ORDER BY id_saran DESC";
                                    $sql = mysqli_query($koneksi, $query);
                                    $no = 0;
